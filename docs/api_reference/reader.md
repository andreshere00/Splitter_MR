...
|-------------------------------------|-------------------------------|---------------------------|------------------|------------------------------------|--------------------------------------|-------------------------|
| <span class="table-badge-cell">[**Vanilla Reader**](#vanillareader)<img class="table-badge table-badge-light" src="../../assets/vanilla_reader_button.svg" alt="Vanilla"><img class="table-badge table-badge-dark" src="../../assets/vanilla_reader_button_white.svg" alt="Vanilla"></span>    | `txt`, `md`, `pdf`            | `xlsx`, `docx`, `pptx`    | `csv`, `tsv`, `parquet` | `json`, `yaml`, `html`, `xml`    | `jpg`, `png`, `webp`, `gif`          | Yes                     |
| <span class="table-badge-cell">[**MarkItDown Reader**](#markitdownreader)<img class="table-badge table-badge-light" src="../../assets/markitdown_reader_button.svg" alt="MarkItDown"><img class="table-badge table-badge-dark" src="../../assets/markitdown_reader_button_white.svg" alt="MarkItDown"></span> | `txt`, `md`, `pdf`            | `docx`, `xlsx`, `pptx`    | `csv`, `tsv`     | `json`, `html`, `xml`             | `jpg`, `png`, `pneg`                 | Yes                     |
| <span class="table-badge-cell">[**Docling Reader**](#doclingreader)<img class="table-badge table-badge-light" src="../../assets/docling_reader_button.svg" alt="Docling"><img class="table-badge table-badge-dark" src="../../assets/docling_reader_button_white.svg" alt="Docling"></span>   | `txt`, `md`, `pdf`            | `docx`, `xlsx`, `pptx`    | –                | `html`, `xhtml`                   | `png`, `jpeg`, `tiff`, `bmp`, `webp` | Yes                     |
| <span class="table-badge-cell">[**Textract Reader**](#textractreader)<img class="table-badge table-badge-light" src="../../assets/textract_reader_button.svg" alt="Textract"><img class="table-badge table-badge-dark" src="../../assets/textract_reader_button_white.svg" alt="Textract"></span> | `txt`, `md`, `pdf`            | `docx`, `xlsx`, `pptx`    | –                | `json`, `yaml`                    | `png`, `jpg`, `jpeg`, `webp`, `gif`, `bmp`, `tif`, `tiff`, `svg` | No |
